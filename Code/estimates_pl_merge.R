...
divergence <- pl_est_merge %>%
  ...
  select(GEOID, 
         ...
         EST_POP_TOT,
         CEN_POP_TOT,
         EST_POP_18P = EST_TOT_TOT_18P,
         CEN_POP_18P,
         EST_POP_17U = EST_TOT_TOT_17U,
         CEN_POP_17U,
         EST_NH_WA_TOT,
         CEN_NH_WA_TOT,
         EST_NH_WA_18P,
  ...
  mutate(EST_NH_WA_PROP = EST_NH_WA_TOT / EST_POP_TOT,
         ...
         EST_NH_WA_18P_PROP = EST_NH_WA_18P / EST_POP_18P,
         EST_NH_BA_18P_PROP = EST_NH_BA_18P / EST_POP_18P,
         EST_NH_AI_18P_PROP = EST_NH_AI_18P / EST_POP_18P,
         EST_NH_AA_18P_PROP = EST_NH_AA_18P / EST_POP_18P,
         EST_NH_NA_18P_PROP = EST_NH_NA_18P / EST_POP_18P,
         EST_NH_TOM_18P_PROP = EST_NH_TOM_18P / EST_POP_18P,
         EST_H_TOT_18P_PROP = EST_H_TOT_18P / EST_POP_18P,
         EST_NH_WA_17U_PROP = EST_NH_WA_17U / EST_POP_17U,
         EST_NH_BA_17U_PROP = EST_NH_BA_17U / EST_POP_17U,
         EST_NH_AI_17U_PROP = EST_NH_AI_17U / EST_POP_17U,
         EST_NH_AA_17U_PROP = EST_NH_AA_17U / EST_POP_17U,
         EST_NH_NA_17U_PROP = EST_NH_NA_17U / EST_POP_17U,
         EST_NH_TOM_17U_PROP = EST_NH_TOM_17U / EST_POP_17U,
         EST_H_TOT_17U_PROP = EST_H_TOT_17U / EST_POP_17U,
         EST_HH_TOT = EST_POP_TOT - EST_GQ_TOT,
